...
/**
 * @generated from message myapp.HelloRequest
 */
export class HelloRequest extends Message<HelloRequest> {
  ...
  static readonly typeName = "myapp.HelloRequest";
...
/**
 * @generated from message myapp.HelloResponse
 */
export class HelloResponse extends Message<HelloResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "myapp.HelloResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
